...
const Skills = () => {
  ...
  const skills = [
    { logo: CodeLogo, title: 'Frontend Developer', id: 1, content: 'Developing focused on Vanilla JS, React and styling with CSS & SASS. Creating user-friendly web applications with attention to detail and clean code.' },
    ...
    { logo: LearnLogo, title: 'Software Dev Teacher', id: 3, content: 'Experienced software development teacher specializing in 3D design and programming. Guiding and mentoring students in the exciting realms of digital experiences, imparting skills in both 3D modeling and programming.' }
  ]
  return (
    <>
